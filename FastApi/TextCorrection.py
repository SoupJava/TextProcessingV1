...
def textcorrectApi(Text):
    #控制台获取
    APPId = "7645b113"
    APISecret = "MzUwMmM2M2M5MDFkZWI4ZWM0ZWJkYzMx"
    APIKey = "d70ebd0c3b78ad15de368b019dc72f4f"

    #需纠错文本
    # Text="若同时定义宽度和高度，则图片会被拉伸或压缩到指定大小；若仅定义宽度或高度，则图会自适应调整大小。所以，建议仅定义宽度即可。"
